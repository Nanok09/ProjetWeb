...
<script>
    ...
    $(document).ready(function () {
        ...
        //création form photo
        $("#ajout_photo").append("<input class='m-2' style='background-color: #153455; color: #fdedcf; text-align: center;' type='hidden' value='" +selected.data().id+ "' name='id_place'/>");
        $("#ajout_photo").append("<input class='m-2' type='file' name='fileToUpload'/></br>");
        $("#ajout_photo").append("<input class='m-2' style='background-color: #153455; color: #fdedcf; text-align: center;' id='ajouter_photo' type='submit' name='action' value='ajouter photo'/>");
    ...
    function print_place_edition(terrain) {
        ...
        $("#edition").append($("<p class='ml-5 mr-2 body-color-blue' style='display: inline-block'>").append($("<strong>").html("Nom")));
        $("#edition").append($("<p class='body-color-blue' style='display: inline-block' id='nom' name='nom'>").html(terrain.nom));
        $("#edition").append($("<br/><p class='ml-5 mr-2 body-color-blue' style='display: inline-block'>").append($("<strong>").html("Description")));
        if (terrain.description == ''){
            $("#edition").append($("<p class='body-color-blue' style='display: inline-block' id='description' name='description'>").html('Pas de description'));
        }else{
            $("#edition").append($("<p class='body-color-blue' style='display: inline-block' id='description' name='description'>").html(terrain.description));
        }
        $("#edition").append($("<br/><p class='ml-5 mr-2 body-color-blue' style='display: inline-block'>").append($("<strong>").html("Adresse (non modifiable)")));
        $("#edition").append($("<p class='body-color-blue' style='display: inline-block' id='current_address'>").html(terrain.adresse));
        $("#edition").append($("<br/><p class='ml-5 mr-2 body-color-blue' style='display: inline-block'>").append($("<strong>").html("Capacité (nombre de personnes)")));
        $("#edition").append($("<p class='body-color-blue' style='display: inline-block' id='capacite' name='capacite'>").html(terrain.capacite));
        $("#edition").append($("<br/><p class='ml-5 mr-2 body-color-blue' style='display: inline-block'>").append($("<strong>").html("prix (horaire)")));
        $("#edition").append($("<p class='body-color-blue' style='display: inline-block' id='prix' name='prix' >").html(terrain.prix));
        $("#edition").append($("<br/><p class='ml-5 mr-2 body-color-blue' style='display: inline-block'>").append($("<strong>").html("sport : ")));
        $("#edition").append($("<p class='body-color-blue' style='display: inline-block' id='sport' name='sport'>").html(terrain.sport));
        ...
        $("#edition").append("</br><div class='row justify-content-center''><input id='submitForm' type='button' name='action' value='Enregistrer' class='btn col-3 mb-5 mt-3 custom-rounded-corners' style='background-color: #153455; color: #fdedcf;' onClick='submit();'></div>");
...
*/
    ...
    function print_new_place_creation() {
        ...
        $("#creation_place").append($("<h2 class='body-color-blue m-5 text-center'>").html("Création d'un nouveau terrain"));
        $("#creation_place").append($("<br/><p class='ml-5 mr-2 body-color-blue' style='display: inline-block'>").append($("<strong>").html("Nom :")));
        $("#creation_place").append("<input class='crea' style='width: 30%' id='nom' type='text' name='nom' placeholder='nom du nouveau terrain'/></br>");
        $("#creation_place").append($("<br/><p class='ml-5 mr-2 body-color-blue' style='display: inline-block'>").append($("<strong>").html("Adresse :")));
        $("#creation_place").append("<input class='crea' style='width: 50%' id='adresse' type='text' placeholder='1500 Avenue Médicis, Paris'/></br>");
        // $("#creation_place").append("<select class='crea' id='choice' name='coord' style='display:none;'></select></br>");
        $("#creation_place").append($("<br/><p class='ml-5 mr-2 body-color-blue' style='display: inline-block'>").append($("<strong>").html("Sport :")));
        $("#creation_place").append("<input class='crea' id='sport' type='text' name='sport' placeholder='exemple : tennis'/></br>");
        $("#creation_place").append($("<br/><p class='ml-5 mr-2 body-color-blue' style='display: inline-block'>").append($("<strong>").html("Prix (horaire) :")));
        $("#creation_place").append("<input class='crea' id='prix' type='number' name='prix' placeholder='exemple : 5'/></br>");
        $("#creation_place").append($("<br/><p class='ml-5 mr-2 body-color-blue' style='display: inline-block'>").append($("<strong>").html("Capacité (nombre de personnes) :")));
        $("#creation_place").append("<input class='crea' id='capacite' type='number' name='capacite' placeholder='exemple : 5'/></br>");
        $("#creation_place").append($("<br/><p class='ml-5 mr-2 body-color-blue' style='display: inline-block'>").append($("<strong>").html("Type :")));
        $("#creation_place").append("<input id='publique' style='display: inline-block' type='radio' name='type' value=0 checked/>" +
        ...
        $("#creation_place").append($("<br/><p class='ml-5 mr-2 body-color-blue' style='display: inline-block'>").append($("<strong>").html("Description générale :")));
        $("#creation_place").append("<br/><div class='row justify-content-center'><textarea cols='100' class='m-3' id='description' class='crea' name='description'></textarea></div></br>");
        $("#creation_place").append($("<br/><h4 class='ml-5 mr-2 mb-3 body-color-blue text-center'>").append($("<strong>").html("Photo du terrain à importer")));
        $("#creation_place").append("<div class='row justify-content-center'><input id='fileToUpload' type='file' name='fileToUpload'/></div></br>");
        $("#creation_place").append("<div class='row justify-content-center''><input id='creation' name='action' type='submit' value='Créer terrain' class='btn col-3 mb-5 mt-3 custom-rounded-corners' style='background-color: #153455; color: #fdedcf;'/></div>");
                        ...
                        <div class="col-10 bg-custom-beige custom-rounded-corners m-5">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-10 bg-custom-grey custom-rounded-corners m-5">
                                    <div class="row justify-content-center">
                                        <form class="mb-4" id="ajout_photo" action="controleur.php" method='post' style="display:none;" enctype="multipart/form-data">
                                            <h3 class="body-color-blue m-5 text-center">Ajouter une photo</h3>
                                        </form>
                                    </div>
                                </div>
                            ...
                            <div class="row justify-content-center">
                                <input class="btn col-3 my-5 custom-rounded-corners" style="background-color: #153455; color: #fdedcf;" id="gerer_creneaux" type="button" value="Gérer mes créneaux"/></br>
                            </div>
                        </div>
                    </div>
                </div>
